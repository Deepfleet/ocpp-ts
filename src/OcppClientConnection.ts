...
export class OcppClientConnection extends Client {
  ...
  on(
    event: 'Authorize',
    listener: (request: AuthorizeRequest, cb: (response: AuthorizeResponse) => void) => void
  ): this;
  on(
  ...
  on(
    event: 'DataTransfer',
    listener: (request: DataTransferRequest, cb: (response: DataTransferResponse) => void) => void
  ): this;
  on(
    event: 'DiagnosticsStatusNotification',
    listener: (
      request: DiagnosticsStatusNotificationRequest,
      cb: (response: DiagnosticsStatusNotificationResponse) => void
    ) => void
  ): this;
  on(
    ...
    listener: (
      ...
      cb: (response: FirmwareStatusNotificationResponse) => void
    ) => void
  ): this;
  on(
    event: 'Heartbeat',
    listener: (request: HeartbeatRequest, cb: (response: HeartbeatResponse) => void) => void
  ): this;
  on(
    event: 'MeterValues',
    listener: (request: MeterValuesRequest, cb: (response: MeterValuesResponse) => void) => void
  ): this;
  on(
    event: 'StartTransaction',
    listener: (
      request: StartTransactionRequest,
      cb: (response: StartTransactionResponse) => void
    ) => void
  ): this;
  on(
  ...
  on(
    ...
    listener: (
      ...
      cb: (response: StopTransactionResponse) => void
    ) => void
  ): this;
  ...
  callRequest(
    ...
    payload: ChangeAvailabilityRequest
  ): Promise<ChangeAvailabilityResponse>;
  callRequest(
    request: 'ChangeConfiguration',
    payload: ChangeConfigurationRequest
  ...
  ): Promise<GetCompositeScheduleResponse>;
  callRequest(
  ...
  callRequest(
    ...
    payload: GetLocalListVersionRequest
  ): Promise<GetLocalListVersionResponse>;
  callRequest(
    request: 'RemoteStartTransaction',
    payload: RemoteStartTransactionRequest
  ): Promise<RemoteStartTransactionResponse>;
  callRequest(
    request: 'RemoteStopTransaction',
  ...
  callRequest(
    ...
    payload: SendLocalListRequest
  ): Promise<SendLocalListResponse>;
  callRequest(
    request: 'SetChargingProfile',
    payload: SetChargingProfileRequest
  ): Promise<SetChargingProfileResponse>;
  callRequest(
  ...
  callRequest(
    ...
    payload: UnlockConnectorRequest
  ): Promise<UnlockConnectorResponse>;
  callRequest(
    request: 'UpdateFirmware',
    payload: UpdateFirmwareRequest
